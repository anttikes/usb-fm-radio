...
This project uses Qt 6.10.2 together with Microsoft Visual Studio Build Tools 2022.

Begin by downloading and installing Microsoft Visual Studio Build Tools 2022 installer. You can find it from [this page](https://aka.ms/vs/17/release/vs_buildtools.exe).
...
Next, visit [this page](https://www.qt.io/development/download-qt-installer-oss) and choose the right Qt installer for your system.
