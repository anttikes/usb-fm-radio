...
#ifndef LOWORD_LOBYTE
#define LOWORD_LOBYTE(x)  (LOBYTE(x))
#endif /* LOWORD_LOBYTE */

#ifndef LOWORD_HIBYTE
#define LOWORD_HIBYTE(x)  (HIBYTE(x))
#endif /* LOWORD_HIBYTE */

#ifndef HIWORD_LOBYTE
#define HIWORD_LOBYTE(x)  ((uint8_t)(((x) >> 16U) & 0x00FFU))
#endif /* HIWORD_LOBYTE */

#ifndef HIWORD_HIBYTE
#define HIWORD_HIBYTE(x)  ((uint8_t)(((x) >> 16U) & 0xFF00U))
#endif /* HIWORD_HIBYTE */
