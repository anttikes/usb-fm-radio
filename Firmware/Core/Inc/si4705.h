...
typedef enum _CMD_FM_TUNE_FREQ_ARGS
{
	...
	/* When set, the blend, hicut and softmute transition as a function of the associated attack/release parameters rather than instantaneously when tuning to an alternate frequency */
...
typedef enum _CMD_FM_RSQ_STATUS_ARGS
{
	...
	/* When set, clears the RSQINT, BLENDINT, SNRHINT, SNRLINT, RSSIHINT, RSSILINT, MULTHINT and MULTLINT interrupt bits */
